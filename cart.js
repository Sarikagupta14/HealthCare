var noti = document.querySelector('.nav h1');
	...
	// Purchase section starts ends

		
	buy.addEventListener('click',function(){
			alert('Proceed for your details and Payment')
			// allData();
			})
			function callvalue(){
				var n= document.getElementById("uname").value;
				...
				var email= document.getElementById("email").value;
				var time= document.getElementById("time").value;
				document.writeln("Congratulations, Your Payment is Successful. Purchase done!! <br> Your Info: <br>" + "Name: "+ n +"<br>");
				document.writeln("Your email:" +  email +"<br>");
				document.writeln("Your Mobile no.:" + number +"<br>");
				document.writeln("Your Payment mode:" + time +"<br>");
